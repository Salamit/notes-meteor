...
if (Meteor.isClient) {
    describe('Editor', function () {
        ...
        /* When we don't have a note nor a selectedId, we get 'Pick or create a note to get started' */
        ...
        it('should render not found message', function () {
            const wrapper = mount (<Editor history = {history} call={call} selectedNoteId={notes[0]._id} Session={Session}/>)
        ...
        it('should remove note', function () {
            ...
            //setup assert for call spy and for push spy
        ...
        it('should update the note body on textarea change', function () {
          ...
          it('should set state for new note', function () {
            ...
            //changing props - from enzyme
            wrapper.setProps({
                seletedNoteId: notes[0]._id,
                note: notes[0]
            });
          ...
          it('should not set state for new note if note prop not provided', function () {
            const wrapper = mount(<Editor history = {history} call={call} Session={Session}/>);
